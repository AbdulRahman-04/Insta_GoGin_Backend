...
type Admin struct {
	...
	Language string `bson:"language,omitempty" json:"language" validate:"required,oneof=Hindi English Urdu Tamil Kannada"`
	AdminVerified struct {
		Email bool `bson:"emaoilVerified" json:"emailVerified"`
